...
const Popconfirm: Component<PopconfirmProps> = (_props) => {
  ...
  const [localProps, popperProps] = splitProps(props, [
    'class',
    'style',
    'title',
    'confirmButtonText',
  ...
  const { t } = useLocale()
  const style = () => ({
    width: addUnit(localProps.width),
    ...localProps.style,
  })
  let popper: PopperInstance

  const finalConfirmButtonText = () =>
    localProps.confirmButtonText || t('el.popconfirm.confirmButtonText')
  const finalCancelButtonText = () =>
    localProps.cancelButtonText || t('el.popconfirm.cancelButtonText')
        ...
        <div class={ns.b()}>
          ...
          <div class={ns.e('action')}>
            <Button
              size="small"
              type={
                localProps.cancelButtonType === 'text'
                  ? undefined
                  : localProps.cancelButtonType
              }
            ...
            <Button
              size="small"
              type={
                localProps.confirmButtonType === 'text'
                  ? undefined
                  : localProps.confirmButtonType
              }
